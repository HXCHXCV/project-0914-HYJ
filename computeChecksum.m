...
% 	---    -------------------------------------
% 	D25    11 1011 0001 1111 0011 0100 1000 0000      0x3B1F3480
% 	D26    01 1101 1000 1111 1001 1010 0100 0000      0x1D8F9A40
% 	D27    10 1110 1100 0111 1100 1101 0000 0000      0x2EC7CD00
% 	D28    01 0111 0110 0011 1110 0110 1000 0000      0x1763E680
% 	D29    10 1011 1011 0001 1111 0011 0100 0000      0x2BB1F340
% 	D30    00 1011 0111 1010 1000 1001 1100 0000      0x0B7A89C0
% -------------------------------------------------------------------------
...
bmask = uint32([hex2dec('3B1F3480'), hex2dec('1D8F9A40'), hex2dec('2EC7CD00'), ...
    hex2dec('1763E680'), hex2dec('2BB1F340'), hex2dec('0B7A89C0')]);

d = bitand(source, uint32(hex2dec('3FFFFFC0')));
% D29 = (source>>31)&0x1UL
D29 = bitand(bitshift(source,-31),uint32(hex2dec('1')));
% D30 = (source>>30)&0x1UL;
D30 = bitand(bitshift(source,-30),uint32(hex2dec('1')));
...
if (niBit)
    ...
    if rem(D30 + countBits(temp0),2)
        % d ^= (0x1UL<<6);
        temp1 = bitshift(uint32(hex2dec('1')),6);
        d = bitxor(d,temp1);
    end
    ...
    if rem(D29 + countBits(temp0),2)
        % d ^= (0x1UL<<7);
        temp1 = bitshift(uint32(hex2dec('1')),7);
        d = bitxor(d,temp1);
    end
end
...
if (D30)
    ...
    Checksum = bitxor(Checksum,uint32(hex2dec('3FFFFFC0')));
end
...
% Output
Checksum = bitand(Checksum,uint32(hex2dec('3FFFFFFF')));
