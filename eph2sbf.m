...
%% =========================== Subframe 1 ===========================
% ------- 1st word --------
sbf1(1) = bitshift(uint32(hex2dec('8B0000')),6);
% ------- 2nd word -------
sbf1(2) = bitshift(uint32(hex2dec('1')),8); %HOW÷±Ω”÷√Œ™1£ø£ø£ø
% ------- 3rd word -------
% ((wn&0x3FFUL)<<20) | ((codeL2&0x3UL)<<18) | ((ura&0xFUL)<<14) | ...  
% ((svhlth&0x3FUL)<<8) | (((iodc>>8)&0x3UL)<<6);
temp0 = bitshift(bitand(wn,uint32(hex2dec('3FF'))),20);
temp1 = bitshift(bitand(codeL2,uint32(hex2dec('3'))),18);
temp2 = bitshift(bitand(ura,uint32(hex2dec('F'))),14);
temp3 = bitshift(bitand(svhlth,uint32(hex2dec('3F'))),8);
temp4 = bitshift(  bitand(bitshift(iodc,-8),uint32(hex2dec('3'))),  6);
...
sbf1(6) = uint32(0);
% ------- 7th word -------
sbf1(7) = bitshift(bitand(tgd,uint32(hex2dec('FF'))),6); % (tgd&0xFFUL)<<6
% ------- 8th word -------
temp0 = bitshift(bitand(iodc,uint32(hex2dec('FF'))),22);
temp1 = bitshift(bitand(toc,uint32(hex2dec('FFFF'))),6);
sbf1(8) = bitor(temp0,temp1);      % ((iodc&0xFFUL)<<22) | ((toc&0xFFFFUL)<<6)
% ------- 9th word -------
temp0 = bitshift(bitand(af2,uint32(hex2dec('FF'))),22);
temp1 = bitshift(bitand(af1,uint32(hex2dec('FFFF'))),6);
sbf1(9) = bitor(temp0,temp1);     % ((af2&0xFFUL)<<22) | ((af1&0xFFFFUL)<<6);
% ------- 10th word -------
sbf1(10) = bitshift(bitand(af0,uint32(hex2dec('3FFFFF'))),8);  % 

%% =========================== Subframe 2 ===========================
% ------- 1st word --------
sbf2(1) = bitshift(uint32(hex2dec('8B0000')),6);         %  0x8B0000UL<<6;
% ------- 2nd word --------
sbf2(2) = bitshift(uint32(hex2dec('2')),8);         %  0x2UL<<8;
% ------- 3rd word --------
temp0 = bitshift(bitand(iode,uint32(hex2dec('FF'))),22);
temp1 = bitshift(bitand(crs,uint32(hex2dec('FFFF'))),6);
sbf2(3) = bitor(temp0,temp1);     % ((iode&0xFFUL)<<22) | ((crs&0xFFFFUL)<<6);
% ------- 4th word --------
temp0 = bitshift(bitand(deltan,uint32(hex2dec('FFFF'))),14);
temp1 = bitshift(  bitand(bitshift(m0,-24),uint32(hex2dec('FF'))),  6);
sbf2(4) = bitor(temp0,temp1);     % ((deltan&0xFFFFUL)<<14) | (((m0>>24)&0xFFUL)<<6);
% ------- 5th word --------
sbf2(5) = bitshift(bitand(m0,uint32(hex2dec('FFFFFF'))),6);       %(m0&0xFFFFFFUL)<<6;
% ------- 6th word --------
temp0 = bitshift(bitand(cuc,uint32(hex2dec('FFFF'))),14);
temp1 = bitshift(  bitand(bitshift(ecc,-24),uint32(hex2dec('0FF'))),  6);
sbf2(6) = bitor(temp0,temp1);     % ((cuc&0xFFFFUL)<<14) | (((ecc>>24)&0xFFUL)<<6);
% ------- 7th word --------
sbf2(7) = bitshift(bitand(ecc,uint32(hex2dec('FFFFFF'))),6);       %(ecc&0xFFFFFFUL)<<6;
% ------- 8th word --------
temp0 = bitshift(bitand(cus,uint32(hex2dec('FFFF'))),14);
temp1 = bitshift(  bitand(bitshift(sqrta,-24),uint32(hex2dec('FF'))),  6);
sbf2(8) = bitor(temp0,temp1);     % ((cus&0xFFFFUL)<<14) | (((sqrta>>24)&0xFFUL)<<6);
% ------- 9th word --------
sbf2(9) = bitshift(bitand(sqrta,uint32(hex2dec('FFFFFF'))),6);       %(sqrta&0xFFFFFFUL)<<6;
% ------- 10th word --------
sbf2(10) = bitshift(bitand(toe,uint32(hex2dec('FFFF'))),14);       % (toe&0xFFFFUL)<<14;

%% =========================== Subframe 3 ===========================
% ------- 1st word --------
sbf3(1) = bitshift(uint32(hex2dec('8B0000')),6);         %  0x8B0000UL<<6;
% ------- 2nd word --------
sbf3(2) = bitshift(uint32(hex2dec('3')),8);         %  0x3UL<<8;
% ------- 3rd word --------
% ((cic&0xFFFFUL)<<14) | (((omg0>>24)&0xFFUL)<<6)
temp0 = bitshift(bitand(cic,uint32(hex2dec('FFFF'))),14);
temp1 = bitshift(omg0,-24);
temp2 = bitshift(bitand(temp1,uint32(hex2dec('FF'))),6);
sbf3(3) = bitor(temp0,temp2);   
% ------- 4th word --------
sbf3(4) = bitshift(bitand(omg0,uint32(hex2dec('FFFFFF'))),6);    % (omg0&0xFFFFFFUL)<<6;
% ------- 5th word --------
temp0 = bitshift(bitand(cis,uint32(hex2dec('FFFF'))),14);
temp1 = bitshift(  bitand(bitshift(inc0,-24),uint32(hex2dec('FF'))),  6);
sbf3(5) = bitor(temp0,temp1);     % ((cis&0xFFFFUL)<<14) | (((inc0>>24)&0xFFUL)<<6);
% ------- 6th word --------
sbf3(6) = bitshift(bitand(inc0,uint32(hex2dec('FFFFFF'))),6);    % (inc0&0xFFFFFFUL)<<6;
% ------- 7th word --------
temp0 = bitshift(bitand(crc,uint32(hex2dec('FFFF'))),14);
temp1 = bitshift(  bitand(bitshift(aop,-24),uint32(hex2dec('FF'))),  6);
sbf3(7) = bitor(temp0,temp1);     % ((crc&0xFFFFUL)<<14) | (((aop>>24)&0xFFUL)<<6);
% ------- 8th word --------
sbf3(8) = bitshift(bitand(aop,uint32(hex2dec('FFFFFF'))),6);    % (aop&0xFFFFFFUL)<<6;
% ------- 9th word --------
sbf3(9) = bitshift(bitand(omgdot,uint32(hex2dec('FFFFFF'))),6);    
% ------- 10th word --------
temp0 = bitshift(bitand(iode,uint32(hex2dec('FF'))),22);
temp1 = bitshift(bitand(idot,uint32(hex2dec('3FFF'))),8);
sbf3(10) = bitor(temp0,temp1);     %((iode&0xFFUL)<<22) | ((idot&0x3FFFUL)<<8);

%% ====================== Subframe 4 (page 25) ====================== 
% ------- 1st word --------
sbf4(1) = bitshift(uint32(hex2dec('8B0000')),6);         %  0x8B0000UL<<6;
% ------- 2nd word --------
sbf4(2) = bitshift(uint32(hex2dec('4')),8);         %  0x4UL<<8;
% ------- 3rd word --------
% (dataId<<28) | (sbf4_page18_svId<<22) | ((alpha0&0xFFUL)<<14) | ((alpha1&0xFFUL)<<6);
temp0 = bitshift(dataId,28);
temp1 = bitshift(sbf4_page18_svId,22);
temp2 = bitshift(bitand(alpha0,uint32(hex2dec('FF'))),14);
temp3 = bitshift(bitand(alpha1,uint32(hex2dec('FF'))),6);
sbf4(3) = comBitor(4,temp0,temp1,temp2,temp3);  
% ------- 4th word --------
% ((alpha2&0xFFUL)<<22) | ((alpha3&0xFFUL)<<14) | ((beta0&0xFFUL)<<6);
temp0 = bitshift(bitand(alpha2,uint32(hex2dec('FF'))),22);
temp1 = bitshift(bitand(alpha3,uint32(hex2dec('FF'))),14);
temp2 = bitshift(bitand(beta0,uint32(hex2dec('FF'))),6);
sbf4(4) = comBitor(3,temp0,temp1,temp2);  
% ------- 5th word --------
% ((beta1&0xFFUL)<<22) | ((beta2&0xFFUL)<<14) | ((beta3&0xFFUL)<<6)
temp0 = bitshift(bitand(beta1,uint32(hex2dec('FF'))),22);
temp1 = bitshift(bitand(beta2,uint32(hex2dec('FF'))),14);
temp2 = bitshift(bitand(beta3,uint32(hex2dec('FF'))),6);
sbf4(5) = comBitor(3,temp0,temp1,temp2);  
% ------- 6th word --------
% (A1&0xFFFFFFUL)<<6;
sbf4(6) = bitshift(bitand(A1,uint32(hex2dec('FFFFFF'))),6);
% ------- 7th word --------
% ((A0>>8)&0xFFFFFFUL)<<6
temp0 = bitand(bitshift(A0,-8),uint32(hex2dec('FFFFFF')));
sbf4(7) = bitshift(temp0,6);
% ------- 8th word --------
% ((A0&0xFFUL)<<22) | ((tot&0xFFUL)<<14) | ((wnt&0xFFUL)<<6)
temp0 = bitshift(bitand(A0,uint32(hex2dec('FF'))),22);
temp1 = bitshift(bitand(tot,uint32(hex2dec('FF'))),14);
temp2 = bitshift(bitand(wnt,uint32(hex2dec('FF'))),6);
sbf4(8) = comBitor(3,temp0,temp1,temp2); 
% ------- 9th word --------
% ((dtls&0xFFUL)<<22) | ((wnlsf&0xFFUL)<<14) | ((dn&0xFFUL)<<6)
temp0 = bitshift(bitand(dtls,uint32(hex2dec('FF'))),22);
temp1 = bitshift(bitand(wnlsf,uint32(hex2dec('FF'))),14);
temp2 = bitshift(bitand(dn,uint32(hex2dec('FF'))),6);
sbf4(9) = comBitor(3,temp0,temp1,temp2); 
% ------- 10th word --------
% (dtlsf&0xFFUL)<<22
sbf4(10) = bitshift(bitand(dtlsf,uint32(hex2dec('FF'))),22);

%% ====================== Subframe 5 (page 25) ======================
% ------- 1st word --------
sbf5(1) = bitshift(uint32(hex2dec('8B0000')),6);        
% ------- 2nd word --------
sbf5(2) = bitshift(uint32(hex2dec('5')),8);         
% ------- 3rd word --------
temp0 = bitshift(dataId,28);
temp1 = bitshift(sbf5_page25_svId,22);
temp2 = bitshift(bitand(toa,uint32(hex2dec('FF'))),14);
temp3 = bitshift(bitand(wna,uint32(hex2dec('FF'))),6);
sbf5(3) = comBitor(4,temp0,temp1,temp2,temp3);
% ------- 4th word -------- Almanac not modulated 
sbf5(4) = uint32(hex2dec('55555555'));
sbf5(5) = uint32(hex2dec('55555555')); 
sbf5(6) = uint32(hex2dec('55555555'));
sbf5(7) = uint32(hex2dec('55555555')); 
sbf5(8) = uint32(hex2dec('55555555')); 
sbf5(9) = uint32(hex2dec('55555555')); 
sbf5(10) = uint32(hex2dec('55555555')); 
